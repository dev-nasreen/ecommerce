                    ...
                    <form action="{{ route('admin.brands.update', $brand->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                ...
                                <div class="controls">
                                    <input type="file" id="inputImage" name="brand_image" class="form-control">
                                    @error('brand_image')
                                    <span class="text-danger">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-6">
                                <img id="showImage"
                                    src="{{ !empty($brand->brand_image) ? asset('uploads/brand/'.$brand->brand_image): asset('frontend/images/brands/brand1.png') }}"
                                    alt="">
                            </div>
                        </div>
